...
const BModalHost: React.FC<ShareModalProps> = ({
  hotel,
  isOpen,
  onClose,
}) => {
  ...
  return (
    <div className={`${styles.sharePopup} ${!isOpen && styles.hidden}`}>
      ...
      <button className={styles.sharePopupClose} onClick={onClose}>
        <FontAwesomeIcon icon={faXmark} />
      </button>
      <span
        onClick={copyToClipboard}
        className="cursor-pointer mx-48 md:mx-60 rounded-lg text-green-600"
      >
        {copyText}
      </span>
    </div>
